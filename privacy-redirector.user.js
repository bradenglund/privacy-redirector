...
const Instances = {
  ...
  hyperpipe: [
    ...
    "hp.ggtyler.dev",
    "hyperpipe.lunar.icu",
    "hp.iqbalrifai.eu.org",
    "hp.ngn.tf",
    "hyperpipe.ducks.party",
    "hyperpipe.darkness.services",
  ],
  proxigram: [
    "ig.opnxng.com",
    "proxigram.lunar.icu",
  ...
  libremdb: [
    ...
    "libremdb.hyperreal.coffee",
    "ld.ca.zorby.top",
    "imdb.nerdvpn.de",
    "libremdb.canine.tools",
    "libremdb-fly.fly.dev",
  ],
  librey: [
    "search.ahwx.org",
    "ly.owo.si",
  ...
  rimgo: [
    ...
    "rg.kuuro.net",
    "rimgo.proxik.cloud",
    "anaimg.starbeamrainbowlabs.com",
    "rimgo.wuemeli.com",
    "rimgo.manerakai.com",
  ],
  scribe: [
  ...
  safetwitch: [
    ...
    "safetwitch.4o1x5.dev",
    "safetwitch.adminforge.de",
    "twitch.blitzw.in",
    "safetwitch.canine.tools",
    "safetwitch.privadency.com",
  ],
  searx: [
